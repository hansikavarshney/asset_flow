      ...
      <div class="timeline-slots-col">
        ...
        <div class="timeline-slots-row">
          ...
          ${resBookings.map(b => {
            ...
            return `
              <div class="timeline-booking-bar event-indigo" style="left:${leftPct}%; width:${widthPct}%;" title="${b.purpose} (Booked by ${booker ? booker.name : 'Unknown'}) [${timeRangeText}]">
    ...
    const body = `
      <form id="new-booking-form">
        ...
        <div class="form-group">
          ...
          <input type="date" id="bk-date" class="form-control" value="${currentDateVal}" required>
        </div>
