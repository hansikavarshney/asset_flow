...
//  Called when user is not authenticated (replaces old auth page)
// ═══════════════════════════════════════════════════════
function renderLandingPage() {
  ...
  root.innerHTML = `
    <div class="lp-root" id="lp-root">
      ...
      <!-- ══ AUTH OVERLAY MODAL ══ -->
      <div class="lp-auth-overlay" id="lp-auth-overlay">
        <div class="lp-auth-modal" id="lp-auth-modal">
          <button class="lp-auth-close" id="lp-auth-close-btn" title="Close">&times;</button>
          <div id="lp-auth-modal-body"></div>
        </div>
      </div>
      ...
      <nav class="lp-nav" id="lp-nav">
        <a class="lp-nav-logo" href="#">
          <div class="lp-nav-logo-mark">AF</div>
          AssetFlow
        </a>
        ...
        <div class="lp-nav-auth">
          <button class="lp-btn-signin" id="lp-signin-nav-btn" onclick="lpOpenSignIn()">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M10 8H2m0 0l2.5-2.5M2 8l2.5 2.5M6 4V3a1 1 0 011-1h6a1 1 0 011 1v10a1 1 0 01-1 1H7a1 1 0 01-1-1v-1"/></svg>
            Sign In
          </button>
          <button class="lp-btn-cta" id="lp-getstarted-nav-btn" onclick="lpOpenSignUp()">
            <svg viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M8 1l1.5 3 3.5.5-2.5 2.5.5 3.5L8 9l-3 1.5.5-3.5L3 4.5 6.5 4z"/></svg>
            Get Started
          </button>
        </div>
        <button class="lp-hamburger" id="lp-hamburger" aria-label="Open menu">
        ...
        <div class="lp-hero-inner">
          <div class="lp-hero-left">
            ...
            <h1 class="lp-hero-h1">
              ...
              <span>Empower Every Team.</span>
            </h1>
            <p class="lp-hero-sub">
              Track assets, allocate resources, automate maintenance, schedule audits, and manage bookings—all from one intelligent ERP platform.
            </p>
            <div class="lp-hero-actions">
              <button class="lp-btn-hero-primary" onclick="lpOpenSignUp()">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M13 5l7 7-7 7M5 5l7 7-7 7"/></svg>
                Start Free
              </button>
              <button class="lp-btn-hero-secondary" onclick="lpOpenSignIn()">
            ...
            <div class="lp-trust-badges">
              <div class="lp-trust-badge"><span class="lp-check">✓</span> Secure</div>
              <div class="lp-trust-badge"><span class="lp-check">✓</span> Cloud Based</div>
              <div class="lp-trust-badge"><span class="lp-check">✓</span> Enterprise Ready</div>
              <div class="lp-trust-badge"><span class="lp-check">✓</span> Role Based Access</div>
            </div>
          </div>
          <div class="lp-hero-right">
            <!-- Floating glass info cards -->
            <div class="lp-float-card lp-float-card-1">
              <div class="lp-float-card-icon" style="background:rgba(34,197,94,.15);">📈</div>
              <div>
                <div style="font-size:0.7rem;color:var(--lp-text-muted);font-weight:500;">Utilization Rate</div>
                <div style="font-size:1rem;font-weight:800;color:var(--lp-success);">+35% ↑</div>
              </div>
            </div>
            <div class="lp-float-card lp-float-card-2">
              <div class="lp-float-card-icon" style="background:rgba(37,99,235,.15);">🔒</div>
              <div>
                <div style="font-size:0.7rem;color:var(--lp-text-muted);font-weight:500;">System Uptime</div>
                <div style="font-size:1rem;font-weight:800;color:var(--lp-primary);">99.9%</div>
              </div>
            </div>
            <!-- Mini Dashboard Mockup -->
            <div class="lp-dashboard-mockup">
              <div class="lp-mock-titlebar">
                <div class="lp-mock-dot red"></div>
                <div class="lp-mock-dot yellow"></div>
                <div class="lp-mock-dot green"></div>
                <div class="lp-mock-titlebar-url">
              ...
              <div class="lp-mock-body">
                <div class="lp-mock-sidebar">
                  <div class="lp-mock-sidebar-logo">
                    <div class="lp-mock-logo-dot"></div>
                    <span class="lp-mock-logo-text">AssetFlow</span>
                  </div>
                  <div class="lp-mock-nav-item active"><div class="lp-mock-nav-dot"></div>Dashboard</div>
                  <div class="lp-mock-nav-item"><div class="lp-mock-nav-dot"></div>Assets</div>
                  <div class="lp-mock-nav-item"><div class="lp-mock-nav-dot"></div>Bookings</div>
                  <div class="lp-mock-nav-item"><div class="lp-mock-nav-dot"></div>Maintenance</div>
                  <div class="lp-mock-nav-item"><div class="lp-mock-nav-dot"></div>Audits</div>
                  <div class="lp-mock-nav-item"><div class="lp-mock-nav-dot"></div>Reports</div>
                </div>
                <div class="lp-mock-main">
                  <div class="lp-mock-topbar">
                    <span class="lp-mock-page-title">🏡 Dashboard</span>
                    <div class="lp-mock-topbar-right">
                      <div class="lp-mock-notif-btn">🔔<div class="lp-mock-notif-dot"></div></div>
                      <div class="lp-mock-avatar">SA</div>
                    </div>
                  </div>
                  <div class="lp-mock-kpi-row">
                    <div class="lp-mock-kpi">
                      <div class="lp-mock-kpi-val">247</div>
                      <div class="lp-mock-kpi-label">Assets Available</div>
                      <div class="lp-mock-kpi-bar"><div class="lp-mock-kpi-bar-fill" style="width:72%"></div></div>
                    </div>
                    <div class="lp-mock-kpi">
                      <div class="lp-mock-kpi-val">84</div>
                      <div class="lp-mock-kpi-label">Allocated</div>
                      <div class="lp-mock-kpi-bar"><div class="lp-mock-kpi-bar-fill" style="width:33%;background:linear-gradient(90deg,#4F46E5,#06B6D4)"></div></div>
                    </div>
                    <div class="lp-mock-kpi">
                      <div class="lp-mock-kpi-val">12</div>
                      <div class="lp-mock-kpi-label">Maintenance</div>
                      <div class="lp-mock-kpi-bar"><div class="lp-mock-kpi-bar-fill" style="width:15%;background:linear-gradient(90deg,#F59E0B,#EF4444)"></div></div>
                    </div>
                  </div>
                  <div class="lp-mock-charts">
                    <div class="lp-mock-chart-card">
                      <div class="lp-mock-chart-title">Asset Utilization (6mo)</div>
                      <div class="lp-mock-bars">
                        <div class="lp-mock-bar" style="height:65%"></div>
                        <div class="lp-mock-bar" style="height:50%"></div>
                        <div class="lp-mock-bar" style="height:80%"></div>
                        <div class="lp-mock-bar" style="height:45%"></div>
                        <div class="lp-mock-bar" style="height:90%"></div>
                        <div class="lp-mock-bar" style="height:70%"></div>
                      </div>
                    </div>
                    <div class="lp-mock-chart-card">
                      <div class="lp-mock-chart-title">Status</div>
                      <div class="lp-mock-donut-wrap">
                        <div class="lp-mock-donut">
                          <svg width="54" height="54" viewBox="0 0 54 54">
                            <circle cx="27" cy="27" r="20" fill="none" stroke="rgba(37,99,235,0.1)" stroke-width="7"/>
                            <circle cx="27" cy="27" r="20" fill="none" stroke="#2563EB" stroke-width="7" stroke-dasharray="88 38" stroke-linecap="round"/>
                            <circle cx="27" cy="27" r="20" fill="none" stroke="#4F46E5" stroke-width="7" stroke-dasharray="28 98" stroke-dashoffset="-88" stroke-linecap="round"/>
                          </svg>
                          <div class="lp-mock-donut-label">72%</div>
                        </div>
                        <div class="lp-mock-donut-legend">
                          <div class="lp-mock-legend-item"><div class="lp-mock-legend-dot" style="background:#2563EB"></div>Active</div>
                          <div class="lp-mock-legend-item"><div class="lp-mock-legend-dot" style="background:#4F46E5"></div>Booked</div>
                          <div class="lp-mock-legend-item"><div class="lp-mock-legend-dot" style="background:#06B6D4"></div>Free</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="lp-mock-activity">
                    <div class="lp-mock-activity-title">Recent Activity</div>
                    <div class="lp-mock-activity-item">
                      <div class="lp-mock-activity-icon" style="background:rgba(34,197,94,.12)">✓</div>
                      <div class="lp-mock-activity-text">
                        <div class="lp-line1">MacBook Pro allocated to Priya S.</div>
                        <div class="lp-line2">Asset AF-0001 · Engineering</div>
                      </div>
                      <div class="lp-mock-activity-time">2m ago</div>
                    </div>
                    <div class="lp-mock-activity-item">
                      <div class="lp-mock-activity-icon" style="background:rgba(245,158,11,.12)">🔧</div>
                      <div class="lp-mock-activity-text">
                        <div class="lp-line1">Maintenance ticket raised</div>
                        <div class="lp-line2">iPad Pro · High Priority</div>
                      </div>
                      <div class="lp-mock-activity-time">15m ago</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <!-- ══ STATISTICS ══ -->
      <section class="lp-stats lp-fade-in">
        <div class="lp-stats-grid">
          <div class="lp-stat-card lp-fade-in">
            <span class="lp-stat-icon">📦</span>
            <span class="lp-stat-number" data-target="50000" id="stat-1">0</span>
            <span class="lp-stat-label">Assets Managed</span>
          </div>
          <div class="lp-stat-card lp-fade-in">
            <span class="lp-stat-icon">🏢</span>
            <span class="lp-stat-number" data-target="1200" id="stat-2">0</span>
            <span class="lp-stat-label">Organizations</span>
          </div>
          <div class="lp-stat-card lp-fade-in">
            <span class="lp-stat-icon">⚡</span>
            <span class="lp-stat-number" data-suffix="%" data-target="99" id="stat-3">0</span>
            <span class="lp-stat-label">System Uptime</span>
          </div>
          <div class="lp-stat-card lp-fade-in">
            <span class="lp-stat-icon">📈</span>
            <span class="lp-stat-number" data-suffix="%" data-target="35" id="stat-4">0</span>
            <span class="lp-stat-label">Operational Efficiency Increase</span>
          </div>
        </div>
      </section>
      ...
      <section class="lp-section" id="features">
        <div class="lp-section-inner">
          <div class="lp-section-header center lp-fade-in">
            <div class="lp-section-label">✦ Platform Features</div>
            <h2 class="lp-section-h2">Everything you need to manage enterprise assets</h2>
            <p class="lp-section-sub">Six powerful modules designed to eliminate inefficiency and give your teams full visibility over every asset.</p>
          </div>
          <div class="lp-features-grid">
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-1">📡</div>
              <div class="lp-feature-title">Asset Tracking</div>
              <p class="lp-feature-desc">Register, tag, and monitor every physical asset with QR codes, serial numbers, and real-time location updates across all departments.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-2">🔄</div>
              <div class="lp-feature-title">Lifecycle Management</div>
              <p class="lp-feature-desc">Track every asset from acquisition to disposal. Log condition changes, depreciation, warranty expiry, and transfer history seamlessly.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-3">📅</div>
              <div class="lp-feature-title">Resource Booking</div>
              <p class="lp-feature-desc">Enable employees to self-serve shared resources—conference rooms, vehicles, equipment—with conflict-free calendar booking.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-4">🛠️</div>
              <div class="lp-feature-title">Maintenance Workflow</div>
              <p class="lp-feature-desc">Automate repair ticket creation, technician assignment, approval workflows, and resolution tracking with priority-based queuing.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-5">📋</div>
              <div class="lp-feature-title">Audit Management</div>
              <p class="lp-feature-desc">Schedule and conduct asset audits by department or location. Generate discrepancy reports and close audit cycles with digital sign-off.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
            <div class="lp-feature-card lp-fade-in">
              <div class="lp-feature-icon lp-feature-icon-6">📊</div>
              <div class="lp-feature-title">Analytics Dashboard</div>
              <p class="lp-feature-desc">Get real-time insights on asset utilization, maintenance costs, overdue returns, and booking trends through interactive visualizations.</p>
              <a class="lp-feature-link" href="#">Learn More →</a>
            </div>
          </div>
        </div>
      ...
      <!-- ══ HOW IT WORKS ══ -->
      <section class="lp-section" id="solutions" style="background:rgba(37,99,235,0.02);">
        <div class="lp-section-inner">
          <div class="lp-section-header center lp-fade-in">
            <div class="lp-section-label">⚡ How It Works</div>
            <h2 class="lp-section-h2">From onboarding to insights in 6 steps</h2>
            <p class="lp-section-sub">AssetFlow fits into your organization's natural workflow—no retraining, no disruption.</p>
          </div>
          <div class="lp-timeline">
            <div class="lp-timeline-track">
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">1</div>
                <div class="lp-timeline-step-title">Register Assets</div>
                <p class="lp-timeline-step-desc">Add assets with tags, categories, and custom fields. Bulk import via CSV.</p>
              </div>
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">2</div>
                <div class="lp-timeline-step-title">Allocate Resources</div>
                <p class="lp-timeline-step-desc">Assign assets to users or departments with expected return dates.</p>
              </div>
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">3</div>
                <div class="lp-timeline-step-title">Track Usage</div>
                <p class="lp-timeline-step-desc">Monitor who holds what, and flag overdue returns automatically.</p>
              </div>
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">4</div>
                <div class="lp-timeline-step-title">Maintenance</div>
                <p class="lp-timeline-step-desc">Employees raise repair tickets; managers approve and assign technicians.</p>
              </div>
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">5</div>
                <div class="lp-timeline-step-title">Audit</div>
                <p class="lp-timeline-step-desc">Run periodic audits with scope-based filters and generate compliance reports.</p>
              </div>
              <div class="lp-timeline-step lp-fade-in">
                <div class="lp-timeline-num">6</div>
                <div class="lp-timeline-step-title">Reports</div>
                <p class="lp-timeline-step-desc">Export analytics and share dashboards with leadership for data-driven decisions.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="lp-section lp-fade-in">
        <div class="lp-section-inner">
          <div class="lp-section-header center lp-fade-in">
            <div class="lp-section-label">🖥️ Product Preview</div>
            <h2 class="lp-section-h2">A platform powerful enough to impress, simple enough to love</h2>
          </div>
          <div class="lp-preview-wrap lp-fade-in">
            <div class="lp-browser-frame">
              <div class="lp-browser-chrome">
                <div class="lp-browser-dots">
                  <div class="lp-browser-dot"></div>
                  <div class="lp-browser-dot"></div>
                  <div class="lp-browser-dot"></div>
                </div>
                <div class="lp-browser-url">
                  🔒 app.assetflow.io/dashboard
                </div>
              </div>
              <div class="lp-browser-content">
                <div class="lp-erp-sidebar">
                  <div class="lp-erp-logo">
                    <div class="lp-erp-logo-mark"></div>
                    <span class="lp-erp-logo-text">AssetFlow</span>
                  </div>
                  <div class="lp-erp-nav-section">Main</div>
                  <div class="lp-erp-nav-item active"><div class="lp-erp-nav-icon"></div>Dashboard</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Asset Directory</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Resource Booking</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Maintenance</div>
                  <div class="lp-erp-nav-section">Operations</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Allocations</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Asset Audits</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Reports</div>
                  <div class="lp-erp-nav-section">Settings</div>
                  <div class="lp-erp-nav-item"><div class="lp-erp-nav-icon"></div>Org Setup</div>
                </div>
                <div class="lp-erp-main">
                  <div class="lp-erp-topbar">
                    <span class="lp-erp-page-title">🏡 Dashboard</span>
                    <div class="lp-erp-topbar-right">
                      <span style="font-size:0.72rem;color:var(--lp-text-muted)">System Admin</span>
                      <div class="lp-erp-btn">+ Register Asset</div>
                    </div>
                  </div>
                  <div class="lp-erp-kpi-row">
                    <div class="lp-erp-kpi">
                      <div class="lp-erp-kpi-top">
                        <div class="lp-erp-kpi-icon" style="background:rgba(34,197,94,.12)">✓</div>
                        <span class="lp-erp-kpi-badge" style="background:rgba(34,197,94,.12);color:#16A34A">+12%</span>
                      </div>
                      <div class="lp-erp-kpi-val">247</div>
                      <div class="lp-erp-kpi-label">Assets Available</div>
                    </div>
                    <div class="lp-erp-kpi">
                      <div class="lp-erp-kpi-top">
                        <div class="lp-erp-kpi-icon" style="background:rgba(37,99,235,.12)">👥</div>
                        <span class="lp-erp-kpi-badge" style="background:rgba(37,99,235,.12);color:#2563EB">Active</span>
                      </div>
                      <div class="lp-erp-kpi-val">84</div>
                      <div class="lp-erp-kpi-label">Assets Allocated</div>
                    </div>
                    <div class="lp-erp-kpi">
                      <div class="lp-erp-kpi-top">
                        <div class="lp-erp-kpi-icon" style="background:rgba(245,158,11,.12)">🔧</div>
                        <span class="lp-erp-kpi-badge" style="background:rgba(245,158,11,.12);color:#D97706">Urgent</span>
                      </div>
                      <div class="lp-erp-kpi-val">3</div>
                      <div class="lp-erp-kpi-label">Maintenance Today</div>
                    </div>
                    <div class="lp-erp-kpi">
                      <div class="lp-erp-kpi-top">
                        <div class="lp-erp-kpi-icon" style="background:rgba(6,182,212,.12)">📅</div>
                        <span class="lp-erp-kpi-badge" style="background:rgba(6,182,212,.12);color:#0891B2">Today</span>
                      </div>
                      <div class="lp-erp-kpi-val">8</div>
                      <div class="lp-erp-kpi-label">Active Bookings</div>
                    </div>
                  </div>
                  <div class="lp-erp-main-cols">
                    <div class="lp-erp-col">
                      <div class="lp-erp-card">
                        <div class="lp-erp-card-title">📁 Asset Registry (Recent)</div>
                        <div class="lp-erp-table-row">
                          <span class="lp-erp-table-tag">AF-0001</span>
                          <span class="lp-erp-table-name">MacBook Pro 16"</span>
                          <span class="lp-erp-status lp-status-allocated">Allocated</span>
                        </div>
                        <div class="lp-erp-table-row">
                          <span class="lp-erp-table-tag">AF-0002</span>
                          <span class="lp-erp-table-name">ThinkPad T14</span>
                          <span class="lp-erp-status lp-status-available">Available</span>
                        </div>
                        <div class="lp-erp-table-row">
                          <span class="lp-erp-table-tag">AF-0004</span>
                          <span class="lp-erp-table-name">Tesla Model 3</span>
                          <span class="lp-erp-status lp-status-available">Available</span>
                        </div>
                        <div class="lp-erp-table-row">
                          <span class="lp-erp-table-tag">AF-0006</span>
                          <span class="lp-erp-table-name">iPad Pro 11"</span>
                          <span class="lp-erp-status lp-status-maintenance">Maintenance</span>
                        </div>
                      </div>
                      <div class="lp-erp-card">
                        <div class="lp-erp-card-title">📊 Utilization by Department</div>
                        <div class="lp-erp-progress">
                          <div class="lp-erp-progress-item">
                            <div class="lp-erp-progress-label"><span>Operations & IT</span><span>87%</span></div>
                            <div class="lp-erp-progress-bar"><div class="lp-erp-progress-fill" style="width:87%;background:linear-gradient(90deg,#2563EB,#4F46E5)"></div></div>
                          </div>
                          <div class="lp-erp-progress-item">
                            <div class="lp-erp-progress-label"><span>Engineering</span><span>64%</span></div>
                            <div class="lp-erp-progress-bar"><div class="lp-erp-progress-fill" style="width:64%;background:linear-gradient(90deg,#06B6D4,#2563EB)"></div></div>
                          </div>
                          <div class="lp-erp-progress-item">
                            <div class="lp-erp-progress-label"><span>Human Resources</span><span>41%</span></div>
                            <div class="lp-erp-progress-bar"><div class="lp-erp-progress-fill" style="width:41%;background:linear-gradient(90deg,#22C55E,#06B6D4)"></div></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="lp-erp-col">
                      <div class="lp-erp-card">
                        <div class="lp-erp-card-title">📅 Upcoming Bookings</div>
                        <div class="lp-erp-upcoming">
                          <div class="lp-erp-booking">
                            <div class="lp-erp-booking-color" style="background:#2563EB"></div>
                            <div class="lp-erp-booking-info">
                              <div class="lp-line1">Conference Room Alpha</div>
                              <div class="lp-line2">Priya S. · Sprint Planning</div>
                            </div>
                            <div class="lp-erp-booking-time">10:00</div>
                          </div>
                          <div class="lp-erp-booking">
                            <div class="lp-erp-booking-color" style="background:#4F46E5"></div>
                            <div class="lp-erp-booking-info">
                              <div class="lp-line1">Tesla Model 3</div>
                              <div class="lp-line2">John D. · Client Visit</div>
                            </div>
                            <div class="lp-erp-booking-time">13:00</div>
                          </div>
                        </div>
                      </div>
                      <div class="lp-erp-card">
                        <div class="lp-erp-card-title">🔧 Maintenance Queue</div>
                        <div class="lp-erp-upcoming">
                          <div class="lp-erp-booking">
                            <div class="lp-erp-booking-color" style="background:#EF4444"></div>
                            <div class="lp-erp-booking-info">
                              <div class="lp-line1">iPad Pro 11"</div>
                              <div class="lp-line2">Screen flickering · High</div>
                            </div>
                            <div class="lp-erp-booking-time" style="color:#EF4444">Approved</div>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <!-- ══ BENEFITS ══ -->
      <section class="lp-section" style="background:rgba(37,99,235,0.02);">
        <div class="lp-section-inner">
          <div class="lp-benefits">
            <div class="lp-benefits-illustration lp-fade-in">
              <div class="lp-benefits-img-wrap">
                <div class="lp-benefits-grid-inner">
                  <div class="lp-benefit-mini-card">
                    <div class="lp-benefit-mini-icon">⏱️</div>
                    <div class="lp-benefit-mini-title">Time Saved</div>
                    <div class="lp-benefit-mini-val">40%</div>
                  </div>
                  <div class="lp-benefit-mini-card">
                    <div class="lp-benefit-mini-icon">💰</div>
                    <div class="lp-benefit-mini-title">Cost Reduced</div>
                    <div class="lp-benefit-mini-val">28%</div>
                  </div>
                  <div class="lp-benefit-mini-card">
                    <div class="lp-benefit-mini-icon">🔁</div>
                    <div class="lp-benefit-mini-title">Audit Accuracy</div>
                    <div class="lp-benefit-mini-val">99%</div>
                  </div>
                  <div class="lp-benefit-mini-card">
                    <div class="lp-benefit-mini-icon">👥</div>
                    <div class="lp-benefit-mini-title">Teams Onboarded</div>
                    <div class="lp-benefit-mini-val">1.2K+</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="lp-benefits-cards">
              <div class="lp-section-header lp-fade-in">
                <div class="lp-section-label">💡 Why AssetFlow</div>
                <h2 class="lp-section-h2">Built for scale. Designed for people.</h2>
              </div>
              <div class="lp-benefit-card lp-fade-in">
                <div class="lp-benefit-card-icon">⚙️</div>
                <div class="lp-benefit-card-content">
                  <div class="lp-benefit-card-title">Reduce Manual Work</div>
                  <div class="lp-benefit-card-desc">Automate repetitive asset tracking, reporting, and notification workflows—freeing your team for high-value work.</div>
                </div>
              </div>
              <div class="lp-benefit-card lp-fade-in">
                <div class="lp-benefit-card-icon">🚫</div>
                <div class="lp-benefit-card-content">
                  <div class="lp-benefit-card-title">Prevent Double Allocation</div>
                  <div class="lp-benefit-card-desc">Real-time availability checks ensure no asset is assigned to two people simultaneously, eliminating conflicts.</div>
                </div>
              </div>
              <div class="lp-benefit-card lp-fade-in">
                <div class="lp-benefit-card-icon">🤖</div>
                <div class="lp-benefit-card-content">
                  <div class="lp-benefit-card-title">Automate Workflows</div>
                  <div class="lp-benefit-card-desc">From maintenance approvals to audit scheduling, AssetFlow triggers the right action at the right time—automatically.</div>
                </div>
              </div>
              <div class="lp-benefit-card lp-fade-in">
                <div class="lp-benefit-card-icon">📡</div>
                <div class="lp-benefit-card-content">
                  <div class="lp-benefit-card-title">Real-time Monitoring</div>
                  <div class="lp-benefit-card-desc">Live dashboards and instant notifications keep every stakeholder informed of asset status changes as they happen.</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="lp-section">
        <div class="lp-section-inner">
          <div class="lp-section-header center lp-fade-in">
            ...
            <h2 class="lp-section-h2">Trusted by enterprise teams worldwide</h2>
          </div>
          <div class="lp-testimonials-grid">
            <div class="lp-testimonial-card lp-fade-in">
              <div class="lp-stars">★★★★★</div>
              <p class="lp-testimonial-quote">"AssetFlow completely replaced our spreadsheet chaos. We went from losing track of assets to having complete visibility in under a week. Game-changer."</p>
              <div class="lp-testimonial-author">
                <div class="lp-testimonial-avatar" style="background:linear-gradient(135deg,#2563EB,#4F46E5)">JS</div>
                <div>
                  <div class="lp-testimonial-name">James Sutherland</div>
                  <div class="lp-testimonial-role">IT Director · Meridian Corp</div>
                </div>
              </div>
            </div>
            <div class="lp-testimonial-card lp-fade-in">
              <div class="lp-stars">★★★★★</div>
              <p class="lp-testimonial-quote">"The maintenance workflow alone saves our operations team 15 hours a week. The booking calendar is intuitive, and our employees adopted it instantly."</p>
              <div class="lp-testimonial-author">
                <div class="lp-testimonial-avatar" style="background:linear-gradient(135deg,#06B6D4,#2563EB)">AR</div>
                <div>
                  <div class="lp-testimonial-name">Ananya Rajan</div>
                  <div class="lp-testimonial-role">COO · TechNova Solutions</div>
                </div>
              </div>
            </div>
            <div class="lp-testimonial-card lp-fade-in">
              <div class="lp-stars">★★★★★</div>
              <p class="lp-testimonial-quote">"Audit season used to be a nightmare. With AssetFlow, we run quarterly audits in hours, not days. The discrepancy reports are incredibly detailed."</p>
              <div class="lp-testimonial-author">
                <div class="lp-testimonial-avatar" style="background:linear-gradient(135deg,#4F46E5,#06B6D4)">MK</div>
                <div>
                  <div class="lp-testimonial-name">Michael Kuznetsov</div>
                  <div class="lp-testimonial-role">CFO · Vertex Dynamics</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="lp-section" style="background:rgba(37,99,235,0.02);">
        <div class="lp-section-inner">
          <div class="lp-section-header center lp-fade-in">
            <div class="lp-section-label">🤝 Trusted By</div>
            <h2 class="lp-section-h2">Leading organizations rely on AssetFlow</h2>
          </div>
          <div class="lp-trusted-grid">
            <div class="lp-logo-pill">MERIDIAN CORP</div>
            <div class="lp-logo-pill">TECHNOVA</div>
            <div class="lp-logo-pill">VERTEX DYNAMICS</div>
            <div class="lp-logo-pill">NOVA SYSTEMS</div>
            <div class="lp-logo-pill">HORIZON GROUP</div>
            <div class="lp-logo-pill">APEX INDUSTRIES</div>
            <div class="lp-logo-pill">CELESTIA INC</div>
            <div class="lp-logo-pill">SYNAPSE TECH</div>
          </div>
        </div>
      </section>

      <!-- ══ FOOTER CTA BANNER ══ -->
      <section class="lp-footer-cta lp-fade-in">
        <h2 class="lp-footer-cta-h2">Ready to simplify enterprise asset management?</h2>
        <p class="lp-footer-cta-sub">Join 1,200+ organizations already running on AssetFlow. Get started for free today.</p>
        <div class="lp-footer-cta-actions">
          <button class="lp-btn-cta-white" onclick="lpOpenSignUp()">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M13 5l7 7-7 7M5 5l7 7-7 7"/></svg>
            Start Free
          </button>
          <button class="lp-btn-cta-outline" onclick="lpOpenSignIn()">
      ...
      <footer class="lp-footer" id="contact">
        <div class="lp-footer-grid">
          <div class="lp-footer-brand">
            <div class="lp-footer-brand-logo">
              <div class="lp-nav-logo-mark" style="width:30px;height:30px;border-radius:9px;font-size:0.72rem;">AF</div>
              AssetFlow
            </div>
            <p class="lp-footer-brand-desc">Enterprise Asset & Resource Management. One platform for every asset, every team, every workflow.</p>
            <div class="lp-footer-social">
              <a class="lp-social-btn" href="#" title="Twitter">𝕏</a>
              <a class="lp-social-btn" href="#" title="LinkedIn">in</a>
              <a class="lp-social-btn" href="#" title="GitHub">gh</a>
              <a class="lp-social-btn" href="#" title="YouTube">▶</a>
            </div>
          </div>
          <div>
            <div class="lp-footer-col-title">Product</div>
            <div class="lp-footer-links">
              <a class="lp-footer-link" href="#">Features</a>
              <a class="lp-footer-link" href="#">Integrations</a>
              <a class="lp-footer-link" href="#">Changelog</a>
              <a class="lp-footer-link" href="#">Roadmap</a>
            </div>
          </div>
          <div>
            <div class="lp-footer-col-title">Company</div>
            <div class="lp-footer-links">
              <a class="lp-footer-link" href="#">About</a>
              <a class="lp-footer-link" href="#">Blog</a>
              <a class="lp-footer-link" href="#">Careers</a>
              <a class="lp-footer-link" href="#">Press</a>
            </div>
          </div>
          <div>
            <div class="lp-footer-col-title">Resources</div>
            <div class="lp-footer-links">
              <a class="lp-footer-link" href="#">Documentation</a>
              <a class="lp-footer-link" href="#">API Reference</a>
              <a class="lp-footer-link" href="#">Status</a>
              <a class="lp-footer-link" href="#">Community</a>
            </div>
          </div>
          <div>
            <div class="lp-footer-col-title">Legal</div>
            <div class="lp-footer-links">
              <a class="lp-footer-link" href="#">Privacy Policy</a>
              <a class="lp-footer-link" href="#">Terms of Service</a>
              <a class="lp-footer-link" href="#">Cookie Policy</a>
              <a class="lp-footer-link" href="#">GDPR</a>
            </div>
          </div>
        </div>
        <div class="lp-footer-bottom">
          ...
          <div class="lp-footer-bottom-links">
            <a class="lp-footer-bottom-link" href="#">Privacy</a>
            <a class="lp-footer-bottom-link" href="#">Terms</a>
            <a class="lp-footer-bottom-link" href="#">Cookies</a>
          </div>
        </div>
      </footer>
  ...
  const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        ...
        const targetEl = entry.target.hasAttribute && entry.target.hasAttribute('data-target') ? entry.target : num;
        if (targetEl && targetEl.hasAttribute('data-target')) {
          const end = +targetEl.getAttribute('data-target');
          const suffix = targetEl.getAttribute('data-suffix') || (end >= 1000 ? '+' : '');
          let start = 0;
          const step = Math.ceil(end / 60);
          const tick = setInterval(() => {
            start = Math.min(start + step, end);
            targetEl.textContent = start.toLocaleString() + suffix;
  ...
  document.querySelectorAll('.lp-fade-in, .lp-timeline-step').forEach(el => observer.observe(el));
  document.querySelectorAll('[data-target]').forEach(el => observer.observe(el));

  // ── Auth overlay close ─────────────────────────────────────
  const overlay = document.getElementById('lp-auth-overlay');
  document.getElementById('lp-auth-close-btn').addEventListener('click', () => lpCloseAuthModal());
  overlay.addEventListener('click', (e) => { if (e.target === overlay) lpCloseAuthModal(); });
  document.addEventListener('keydown', (e) => { if (e.key === 'Escape') lpCloseAuthModal(); });
...
// ── Auth Modal Helpers ─────────────────────────────────────
function lpOpenAuthModal() {
  const overlay = document.getElementById('lp-auth-overlay');
  if (overlay) { overlay.classList.add('open'); document.body.style.overflow = 'hidden'; }
}
function lpCloseAuthModal() {
  const overlay = document.getElementById('lp-auth-overlay');
  if (overlay) { overlay.classList.remove('open'); document.body.style.overflow = ''; }
}

function lpOpenSignIn() {
  lpOpenAuthModal();
  const body = document.getElementById('lp-auth-modal-body');
  body.innerHTML = \`
    <div class="lp-auth-logo-row">
      <div class="lp-auth-logo-mark">AF</div>
      <span class="lp-auth-logo-name">AssetFlow</span>
    </div>
    <h2 class="lp-auth-title">Welcome back</h2>
    <p class="lp-auth-subtitle">Sign in to your enterprise workspace</p>
    <form class="lp-auth-form" id="lp-login-form">
      <div>
        <label class="lp-auth-label" for="lp-login-email">Corporate Email</label>
        <input class="lp-auth-input" id="lp-login-email" type="email" placeholder="name@company.com" value="admin@assetflow.com" required autocomplete="email"/>
      </div>
      <div>
        <label class="lp-auth-label" for="lp-login-password">Password</label>
        <input class="lp-auth-input" id="lp-login-password" type="password" placeholder="••••••••" value="admin123" required autocomplete="current-password"/>
      </div>
      <button type="submit" class="lp-auth-submit">Sign In to AssetFlow</button>
    </form>
    <div class="lp-auth-divider"><hr/><span>or</span><hr/></div>
    <div class="lp-auth-switch">Don't have an account? <span class="lp-auth-switch-link" onclick="lpOpenSignUp()">Get Started →</span></div>
    <div class="lp-auth-demo-box">
      <div class="lp-auth-demo-title">🔑 Demo Accounts</div>
      <div class="lp-auth-demo-row">
        <span class="lp-auth-demo-label">System Admin</span>
        <span class="lp-auth-demo-btn" onclick="lpFillDemo('admin@assetflow.com','admin123')">Use Admin</span>
      </div>
      <div class="lp-auth-demo-row">
        <span class="lp-auth-demo-label">Asset Manager</span>
        <span class="lp-auth-demo-btn" onclick="lpFillDemo('sarah.c@assetflow.com','manager123')">Use Manager</span>
      </div>
      <div class="lp-auth-demo-row">
        <span class="lp-auth-demo-label">Employee</span>
        <span class="lp-auth-demo-btn" onclick="lpFillDemo('priya.s@assetflow.com','user123')">Use Employee</span>
      </div>
    </div>
  \`;
  document.getElementById('lp-login-form').addEventListener('submit', (e) => {
    e.preventDefault();
    const email = document.getElementById('lp-login-email').value;
    const pass  = document.getElementById('lp-login-password').value;
    if (loginUser(email, pass)) lpCloseAuthModal();
  });
}
...
function lpOpenSignUp() {
  ...
  body.innerHTML = \`
    ...
    <h2 class="lp-auth-title">Create account</h2>
    <p class="lp-auth-subtitle">Join your organization's asset management workspace</p>
    <form class="lp-auth-form" id="lp-signup-form">
      <div>
        <label class="lp-auth-label" for="lp-signup-name">Full Name</label>
        <input class="lp-auth-input" id="lp-signup-name" type="text" placeholder="Jane Doe" required autocomplete="name"/>
      </div>
      <div>
        <label class="lp-auth-label" for="lp-signup-email">Corporate Email</label>
        <input class="lp-auth-input" id="lp-signup-email" type="email" placeholder="name@company.com" required autocomplete="email"/>
      </div>
      <div>
        <label class="lp-auth-label" for="lp-signup-password">Password</label>
        <input class="lp-auth-input" id="lp-signup-password" type="password" placeholder="Create a strong password" required autocomplete="new-password"/>
      </div>
      <button type="submit" class="lp-auth-submit">✦ Get Started Free</button>
    </form>
    <div class="lp-auth-divider"><hr/><span>or</span><hr/></div>
    <div class="lp-auth-switch">Already have an account? <span class="lp-auth-switch-link" onclick="lpOpenSignIn()">← Sign In</span></div>
  \`;
  document.getElementById('lp-signup-form').addEventListener('submit', (e) => {
    e.preventDefault();
    const name  = document.getElementById('lp-signup-name').value;
    const email = document.getElementById('lp-signup-email').value;
    const pass  = document.getElementById('lp-signup-password').value;
    if (signupUser(name, email, pass)) lpOpenSignIn();
  });
}

window.lpFillDemo = function(email, pass) {
  const emailEl = document.getElementById('lp-login-email');
  const passEl  = document.getElementById('lp-login-password');
...
function renderDashboard(container) {
  ...
  const recentLogs = currentUser.role === 'Admin' ? AssetFlowDB.getAll('logs').sort((a,b)=> new Date(b.timestamp) - new Date(a.timestamp)).slice(0, 5) : [];

  container.innerHTML = `
    <div class="hero-strip">
      <div>
        <h2 style="margin:0; font-size:1.8rem; font-weight:700; letter-spacing:-0.5px;">AssetFlow Enterprise</h2>
        <div style="font-size:0.9rem; margin-top:0.5rem; opacity:0.9;">Overview for ${currentUser.name}</div>
      </div>
      <div style="text-align:right;">
        <div style="font-size:1.6rem; font-weight:700; font-variant-numeric: tabular-nums;" id="live-clock">--:--:--</div>
        <div style="font-size:0.8rem; opacity:0.9;">${new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</div>
      </div>
    </div>
    ...
    <div class="kpi-grid">
      <div class="kpi-card" onclick="navigateTo('directory')">
        ...
        <div class="kpi-info" style="flex:1;">
          <span class="kpi-value animated-counter" data-target="${availableCount}">0</span>
          <span class="kpi-title">Assets Available</span>
          <svg style="margin-top:0.5rem; width:100%; height:20px;" viewBox="0 0 100 20" preserveAspectRatio="none"><path d="M0,15 L20,10 L40,12 L60,5 L80,8 L100,2" stroke="var(--success)" stroke-width="2" fill="none"/></svg>
        </div>
      </div>
      <div class="kpi-card" onclick="navigateTo('directory')">
        <div class="kpi-icon-wrapper kpi-allocated"><i data-lucide="users"></i></div>
        <div class="kpi-info" style="flex:1;">
          <span class="kpi-value animated-counter" data-target="${allocatedCount}">0</span>
          <span class="kpi-title">Assets Allocated</span>
          <svg style="margin-top:0.5rem; width:100%; height:20px;" viewBox="0 0 100 20" preserveAspectRatio="none"><path d="M0,18 L20,15 L40,16 L60,10 L80,4 L100,5" stroke="var(--primary)" stroke-width="2" fill="none"/></svg>
        </div>
      </div>
      <div class="kpi-card" onclick="navigateTo('maintenance')">
        <div class="kpi-icon-wrapper kpi-maintenance"><i data-lucide="wrench"></i></div>
        <div class="kpi-info" style="flex:1;">
          <span class="kpi-value animated-counter" data-target="${maintenanceCount}">0</span>
          <span class="kpi-title">Maintenance Today</span>
          <svg style="margin-top:0.5rem; width:100%; height:20px;" viewBox="0 0 100 20" preserveAspectRatio="none"><path d="M0,10 L20,12 L40,8 L60,8 L80,15 L100,10" stroke="var(--warning)" stroke-width="2" fill="none"/></svg>
        </div>
      </div>
      <div class="kpi-card" onclick="navigateTo('booking')">
        <div class="kpi-icon-wrapper kpi-bookings"><i data-lucide="calendar"></i></div>
        <div class="kpi-info" style="flex:1;">
          <span class="kpi-value animated-counter" data-target="${activeBookingsCount}">0</span>
          <span class="kpi-title">Active Bookings</span>
          <svg style="margin-top:0.5rem; width:100%; height:20px;" viewBox="0 0 100 20" preserveAspectRatio="none"><path d="M0,15 L20,10 L40,5 L60,15 L80,5 L100,0" stroke="var(--info)" stroke-width="2" fill="none"/></svg>
        </div>
      </div>
      ...
      <div class="kpi-card" onclick="navigateTo('allocation')">
        ...
        <div class="kpi-info">
          <span class="kpi-value animated-counter" data-target="${pendingTransfersCount}">0</span>
      ...
      <div class="kpi-card" onclick="navigateTo('${currentUser.role === 'Employee' ? 'directory' : 'allocation'}')">
        ...
        <div class="kpi-info">
          <span class="kpi-value animated-counter" data-target="${overdueAlls.length}">0</span>
  ...
  if (clockEl) {
    const updateClock = () => { if(document.getElementById('live-clock')) document.getElementById('live-clock').innerText = new Date().toLocaleTimeString('en-US', { hour12: false }); };
    updateClock(); setInterval(updateClock, 1000);
  }

  // Animate KPI Counters
  document.querySelectorAll('.animated-counter').forEach(c => {
    const target = +c.getAttribute('data-target');
    let count = 0;
    const speed = Math.ceil(target / 15) || 1;
...
function renderAssetDirectory(container) {
    ...
    <div class="card">
      ...
      <div class="table-container">
        <table id="assets-directory-table">
          <thead>
            <tr>
              <th style="width:40px;"><input type="checkbox" id="selectAll" onclick="toggleAllAssets(this)"></th>
              <th>Asset Tag</th>
              <th>Asset Name</th>
              <th>Category</th>
              <th>Serial Number</th>
      ...
      <!-- Bulk Actions Bar -->
      <div id="bulk-actions-bar" style="display:none; position:fixed; bottom:20px; left:50%; transform:translateX(-50%); background:var(--bg-primary); padding:1rem 2rem; border-radius:30px; box-shadow:var(--shadow-lg); z-index:100; border:1px solid var(--border-color); align-items:center; gap:1.5rem;">
        <span id="bulk-actions-count" style="font-weight:600;">0 selected</span>
        <button class="btn btn-secondary btn-sm" onclick="bulkExportCSV()"><i data-lucide="download"></i> Export CSV</button>
      </div>
    </div>
  `;
  ...
  window.filterAssetsDirectory = function() {
    ...
    const tbody = document.querySelector('#assets-directory-table tbody');
    if (tbody) {
      tbody.innerHTML = filtered.length === 0 ? '<tr><td colspan="10" style="text-align:center; color:var(--text-muted);"><div class="empty-state"><i data-lucide="search"></i><p>No assets match your search parameters.</p></div></td></tr>' : filtered.map(a => {
        const cat = cats.find(c => c.id === a.categoryId);
        return `
          <tr>
            <td><input type="checkbox" class="asset-checkbox" value="${a.id}" onclick="updateBulkActions()"></td>
            <td><strong style="color:var(--primary);">${a.tag}</strong></td>
            <td><strong>${a.name}</strong></td>
            <td>${cat ? cat.name : 'Unknown'}</td>
            <td><span style="font-family: monospace; color:var(--text-secondary);">${a.serialNumber}</span></td>
            <td>${a.condition}</td>
            <td>${a.location}</td>
            <td>${a.isBookable ? '<i data-lucide="check" style="color:var(--success);"></i>' : '<i data-lucide="x" style="color:var(--text-muted);"></i>'}</td>
            <td><span class="badge badge-${a.status.replace(' ', '-').toLowerCase()}">${a.status}</span></td>
            <td>
              <div style="display:flex; gap:0.5rem;">
                <button class="btn btn-secondary btn-sm" onclick="openAssetDetailModal('${a.id}')"><i data-lucide="eye"></i></button>
                ${(currentUser.role === 'Admin' || currentUser.role === 'Asset Manager') ? `<button class="btn btn-secondary btn-sm" onclick="openRegisterAssetModal('${a.id}')"><i data-lucide="edit"></i></button>` : ''}
              </div>
            </td>
          </tr>
        `;
  ...
  window.toggleAllAssets = function(source) {
  ...
  window.updateBulkActions = function() {
    ...
    if (bar) {
      if (count > 0) {
        ...
        document.getElementById('bulk-actions-count').innerText = count + ' selected';
        bar.style.animation = 'fadeSlideIn 0.2s ease-out forwards';
      } else {
  ...
  window.bulkExportCSV = function() {
    showToast('Exported selected assets to CSV!', 'success');
  };
  ...
  window.openAssetDetailModal = function(assetId) {
    ...
    const body = `
      <div class="detail-grid">
        <div style="grid-column: 1 / -1; display:flex; justify-content:space-between; align-items:flex-start;">
          ...
          <div id="qr-code-container-${a.id}" style="padding: 10px; background: white; border-radius: 8px;"></div>
        </div>
        <div>
    ...
    if (!a.isBookable && (currentUser.role === 'Admin' || currentUser.role === 'Asset Manager')) {
      if (a.status === 'Available') {
        footerHTML += ` <button class="btn btn-primary" onclick="closeModal(); openNewAllocationModal('${a.id}')"><i data-lucide="plus"></i> Allocate</button>`;
      } else if (a.status === 'Allocated') {
        footerHTML += ` <button class="btn btn-primary" onclick="closeModal(); openNewAllocationModal('${a.id}')"><i data-lucide="arrow-left-right"></i> Transfer</button>`;
      }
    }
    openModal(`Asset Info: ${a.name}`, body, footerHTML);
    
    // Generate QR Code
    setTimeout(() => {
      if (typeof QRCode !== 'undefined') {
        new QRCode(document.getElementById(`qr-code-container-${a.id}`), {
          text: a.tag,
          width: 80,
          height: 80,
          colorDark : "#000000",
...
function renderAssetAllocation(container) {
  ...
  window.openNewAllocationModal = function(preSelectedAssetId = null) {
    const assetsList = AssetFlowDB.getAll('assets').filter(a => !a.isBookable);
      ...
      <form id="allocate-form">
        <div class="form-group">
          ...
          <select id="alc-asset" class="form-control" required>
            ...
            ${assetsList.map(a => {
              let label = `${a.tag} - ${a.name} (${a.location})`;
              if (a.status === 'Allocated') {
                const activeAlc = AssetFlowDB.getAll('allocations').find(al => al.assetId === a.id && (al.status === 'Active' || al.status === 'Overdue'));
                let holderName = 'Unknown';
                if (activeAlc) {
                  holderName = activeAlc.allocatedTo === 'user' ? 
                    (AssetFlowDB.getById('users', activeAlc.targetId)?.name || 'Unknown') :
                    (AssetFlowDB.getById('departments', activeAlc.targetId)?.name || 'Unknown');
                }
                label += ` [Held by: ${holderName}]`;
              } else if (a.status !== 'Available') {
                label += ` [Status: ${a.status}]`;
              }
              const isSel = a.id === preSelectedAssetId ? 'selected' : '';
              return `<option value="${a.id}" ${isSel}>${label}</option>`;
            }).join('')}
          </select>
        </div>
  ...
  window.submitAllocation = function() {
    ...
    if (asset.status === 'Allocated') {
      const activeAlc = AssetFlowDB.getAll('allocations').find(al => al.assetId === asset.id && (al.status === 'Active' || al.status === 'Overdue'));
      let holderName = 'Unknown';
      let fromUserId = null;
      if (activeAlc) {
        fromUserId = activeAlc.allocatedTo === 'user' ? activeAlc.targetId : null;
        holderName = activeAlc.allocatedTo === 'user' ? 
          (AssetFlowDB.getById('users', activeAlc.targetId)?.name || 'Unknown') :
          (AssetFlowDB.getById('departments', activeAlc.targetId)?.name || 'Unknown');
      }
      ...
      const targetName = targetType === 'user' ? 
        (AssetFlowDB.getById('users', targetId)?.name || 'Unknown') : 
        (AssetFlowDB.getById('departments', targetId)?.name || 'Unknown');

      // Double allocation conflict block - suggest transfer
      const conflictBody = `
        <div style="padding: 0.5rem 0;">
          <p style="margin-bottom: 1rem; color: var(--danger); font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
            <i data-lucide="alert-triangle"></i> Allocation Conflict Detected
          </p>
          <p style="margin-bottom: 1rem; font-size: 0.9rem; line-height: 1.5;">
            Asset <strong>${asset.tag} - ${asset.name}</strong> is currently held by <strong>${holderName}</strong>. 
            You cannot allocate it directly.
          </p>
          <p style="margin-bottom: 1.5rem; font-size: 0.9rem; line-height: 1.5; color: var(--text-secondary);">
            Would you like to initiate an <strong>Inter-Employee Transfer Request</strong> to transfer this asset from 
            <strong>${holderName}</strong> to <strong>${targetName}</strong>?
          </p>
          <input type="hidden" id="tf-conflict-asset-id" value="${asset.id}">
          <input type="hidden" id="tf-conflict-from-user-id" value="${fromUserId || ''}">
          <input type="hidden" id="tf-conflict-to-user-id" value="${targetId}">
        </div>
      `;

      const conflictFooter = `
        <button class="btn btn-secondary" onclick="openNewAllocationModal('${assetId}')">Back</button>
        <button class="btn btn-primary" onclick="submitConflictTransfer()">Request Transfer</button>
      `;

      openModal('Allocation Conflict', conflictBody, conflictFooter);
      return;
    }

    if (asset.status !== 'Available') {
      showToast(`Conflict: This asset is currently not available (Status: ${asset.status})`, 'danger');
      return;
    }
  ...
  // Conflict Transfer submit helper
  window.submitConflictTransfer = function() {
    const assetId = document.getElementById('tf-conflict-asset-id').value;
    const fromUserId = document.getElementById('tf-conflict-from-user-id').value || null;
    const toUserId = document.getElementById('tf-conflict-to-user-id').value;

    const asset = AssetFlowDB.getById('assets', assetId);
    const recipient = AssetFlowDB.getById('users', toUserId);

    // Create transfer request
    AssetFlowDB.insert('transfers', {
      assetId,
      fromUserId,
      toUserId,
    ...
    AssetFlowDB.log(currentUser.id, currentUser.name, 'Initiate Transfer', `Requested transfer of ${asset.name} (${asset.tag}) to user ${recipient.name} due to allocation conflict`);
...
function renderResourceBooking(container) {
  ...
  container.innerHTML = `
    <div class="card">
      ...
      <!-- Resource List & Date Selector -->
      <div class="filter-row" style="margin-bottom: 2rem; display:flex; gap:1.5rem; flex-wrap:wrap;">
        <div style="display:flex; align-items:center; gap:0.5rem;">
          <label style="font-weight:600; font-size:0.85rem; color:var(--text-secondary);">Select Resource:</label>
          <select id="booking-resource-select" class="form-control" style="width:250px;" onchange="updateBookingScheduleView()">
            ${assets.map((a, i) => `<option value="${a.id}" ${i === 0 ? 'selected' : ''}>${a.name} (${a.location})</option>`).join('')}
          </select>
        </div>
        <div style="display:flex; align-items:center; gap:0.5rem;">
          <label style="font-weight:600; font-size:0.85rem; color:var(--text-secondary);">Schedule Date:</label>
          <input type="date" id="booking-calendar-date" class="form-control" style="width:180px;" value="2026-07-12" onchange="updateBookingScheduleView()">
        </div>
      </div>
      ...
      <h4 id="resource-schedule-title" style="margin-bottom:1rem; font-size:0.95rem; display:flex; align-items:center; gap:0.5rem; color:var(--primary);">
        <i data-lucide="clock"></i> Reservation Timeline
      </h4>
  ...
  // Draw resource schedule timeline for selected resource and date
  window.loadResourceSchedule = function(assetId, dateStr = '2026-07-12') {
    if (!assetId) return;
    const res = assets.find(a => a.id === assetId);
    if (!res) return;

    const displayDate = new Date(dateStr).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' });
    document.getElementById('resource-schedule-title').innerHTML = `<i data-lucide="clock"></i> Reservation Timeline - ${res.name} (${displayDate})`;
    ...
    // Fetch bookings for this resource on selected date
    const resBookings = bookings.filter(b => b.assetId === assetId && b.startTime.startsWith(dateStr) && b.status !== 'Cancelled');
    ...
    let timelineHTML = `
      ...
      <div class="timeline-slots-col">
        ...
        <div class="timeline-slots-row"
             ...
             ondrop="window.handleBookingDrop(event, '${assetId}', '${dateStr}')">
          ...
          ${resBookings.map(b => {
            ...
            const gridStart = 8;
            const displayStart = Math.max(gridStart, Math.min(18, startHour));
            const displayEnd = Math.max(gridStart, Math.min(18, endHour));

            if (displayEnd <= displayStart) return '';

            const leftPct = ((displayStart - gridStart) / 10) * 100;
            const widthPct = ((displayEnd - displayStart) / 10) * 100;
            
            const booker = users.find(u => u.id === b.userId);
            const timeRangeText = `${String(startDate.getHours()).padStart(2,'0')}:${String(startDate.getMinutes()).padStart(2,'0')} - ${String(endDate.getHours()).padStart(2,'0')}:${String(endDate.getMinutes()).padStart(2,'0')}`;
            
            return `
              <div class="booking-block"
                   draggable="true"
                   ondragstart="event.dataTransfer.setData('text/plain', '${b.id}')"
                   style="left: ${leftPct}%; width: ${widthPct}%; background-color: var(--primary);">
                <div class="booking-block-title">${b.purpose}</div>
                <div class="booking-block-time">${timeRangeText}</div>
              </div>
            `;
          }).join('')}
        </div>
  ...
  // Switch schedule view event helper
  window.updateBookingScheduleView = function() {
    const assetId = document.getElementById('booking-resource-select').value;
    const dateStr = document.getElementById('booking-calendar-date').value;
    loadResourceSchedule(assetId, dateStr);
  };

  window.handleBookingDrop = function(event, assetId, dateStr) {
    event.preventDefault();
    const bookingId = event.dataTransfer.getData('text/plain');
    if (!bookingId) return;
    
    // Calculate new start time based on drop X offset
    const row = event.currentTarget;
    const rect = row.getBoundingClientRect();
    const x = event.clientX - rect.left;
    const pct = x / rect.width;
    // Timeline spans 10 hours from 8:00
    const droppedHour = 8 + (pct * 10);
    const startHour = Math.floor(droppedHour);
    const startMin = Math.round((droppedHour - startHour) * 60 / 15) * 15; // snap to 15 min
    ...
    // format back to ISO-like local
    const formatLocal = (d) => `${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,'0')}-${String(d.getDate()).padStart(2,'0')}T${String(d.getHours()).padStart(2,'0')}:${String(d.getMinutes()).padStart(2,'0')}:00`;
    
    const newStartStr = formatLocal(newStart);
    const newEndStr = formatLocal(newEnd);

    // Conflict check
    const bookings = AssetFlowDB.getAll('bookings');
    const hasOverlap = bookings.some(ob => {
      if (ob.id === bookingId || ob.assetId !== assetId || ob.status === 'Cancelled') return false;
      return (new Date(newStartStr) < new Date(ob.endTime)) && (new Date(newEndStr) > new Date(ob.startTime));
    });

    if (hasOverlap) {
      showToast('Cannot move here: Time slot overlaps with another booking', 'danger');
      return;
    }

    // Update the booking
    AssetFlowDB.update('bookings', bookingId, { startTime: newStartStr, endTime: newEndStr });
    showToast('Booking rescheduled successfully', 'success');
    
    AssetFlowDB.log(currentUser.id, currentUser.name, 'Reschedule Booking', `Dragged booking ${bookingId} to new time`);
    loadResourceSchedule(assetId, dateStr);
  };
  ...
  window.openNewBookingModal = function() {
    ...
    const currentDateVal = document.getElementById('booking-calendar-date')?.value || '2026-07-12';
    const currentAssetVal = document.getElementById('booking-resource-select')?.value || '';
    
    const body = `
      <form id="new-booking-form">
        <div id="booking-conflict-warning" style="display:none; color:var(--danger); padding:0.5rem; background:var(--danger-glow); border-radius:4px; margin-bottom:1rem; font-size:0.9rem;">
          <i data-lucide="alert-triangle" style="width:16px; height:16px; vertical-align:middle; margin-right:4px;"></i> Conflict detected with an existing booking!
        </div>
        <div class="form-group">
          <label>Select Shared Resource</label>
          <select id="bk-asset" class="form-control" required onchange="window.checkBookingConflict()">
            ${bookableAssets.map(a => `<option value="${a.id}" ${a.id === currentAssetVal ? 'selected' : ''}>${a.name} (${a.location})</option>`).join('')}
          </select>
        </div>

        <div class="form-group">
          <label>Booking Date</label>
          <input type="date" id="bk-date" class="form-control" value="${currentDateVal}" required onchange="window.checkBookingConflict()">
        </div>

        <div class="form-row">
          <div class="form-group">
            <label>Start Time (Hour)</label>
            <input type="time" id="bk-start" class="form-control" value="10:00" required oninput="window.checkBookingConflict()">
          </div>
          <div class="form-group">
            <label>End Time (Hour)</label>
            <input type="time" id="bk-end" class="form-control" value="11:00" required oninput="window.checkBookingConflict()">
          </div>
        </div>
  ...
  window.checkBookingConflict = function() {
    ...
    const warn = document.getElementById('booking-conflict-warning');
    if (!assetId || !date || !start || !end || !warn) return;
  ...
  if (assets.length > 0) {
    const defaultDateStr = document.getElementById('booking-calendar-date')?.value || '2026-07-12';
    loadResourceSchedule(assets[0].id, defaultDateStr);
...
function renderActivityLogs(container) {
  ...
  const actionIconMap = {
    'User Logged In': 'log-in', 'User Logged Out': 'log-out', 'User Registered': 'user-plus',
    'Dev Account Switch': 'repeat', 'Register Asset': 'plus-circle', 'Edit Asset': 'edit',
    'Allocate Asset': 'user-check', 'Return Asset': 'undo', 'Promote Role': 'arrow-up-circle',
    'Toggle User Status': 'power', 'Resolve Maintenance': 'check-circle-2',
    'Close Audit': 'clipboard-check', 'Cancel Booking': 'x-circle',
    'Create Department': 'building', 'Edit Department': 'building-2',
    'Reschedule Booking': 'calendar', 'Raise Maintenance': 'alert-triangle'
  };

  const actionColorMap = {
    'User Logged In': 'var(--success)', 'User Logged Out': 'var(--text-muted)',
    'User Registered': 'var(--primary)', 'Allocate Asset': 'var(--info)',
    'Resolve Maintenance': 'var(--success)', 'Close Audit': 'var(--accent)',
    'Cancel Booking': 'var(--danger)', 'Promote Role': 'var(--warning)'
  };

  const groupedByDate = {};
  logs.forEach(l => {
    const dateKey = new Date(l.timestamp).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
    ...
    <div class="card">
      <div style="display:flex; justify-content:space-between; margin-bottom:1.5rem; align-items:center; flex-wrap:wrap; gap:1rem;">
        <h3 style="font-size:1.1rem; font-weight:600; display:flex; align-items:center; gap:0.5rem;">
          <i data-lucide="scroll"></i> Security Audit Trail
        </h3>
        <span style="font-size:0.85rem; color:var(--text-muted);">${logs.length} events logged</span>
      </div>
      ...
      ` : Object.entries(groupedByDate).map(([dateKey, dayLogs]) => `
        <div style="margin-bottom:2rem;">
          <div style="font-size:0.75rem; font-weight:600; color:var(--text-muted); text-transform:uppercase; letter-spacing:0.08em; margin-bottom:1.25rem; display:flex; align-items:center; gap:0.75rem;">
          ...
          <div class="activity-timeline">
            ${dayLogs.map(l => {
              const icon = actionIconMap[l.action] || 'activity';
              const dotColor = actionColorMap[l.action] || 'var(--primary)';
              const t = new Date(l.timestamp);
              const timeStr = t.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
              return `
                <div class="activity-item" style="display:flex; gap:1rem; align-items:flex-start;">
                  <div style="display:flex; flex-direction:column; align-items:center; gap:0;">
                    <div style="width:36px; height:36px; border-radius:50%; background:${dotColor}22; border:2px solid ${dotColor}; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                      <i data-lucide="${icon}" style="width:16px; height:16px; color:${dotColor};"></i>
                    </div>
                  </div>
                  <div style="flex:1; padding-bottom:1.5rem; border-bottom:1px solid var(--border-color);">
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:1rem; flex-wrap:wrap;">
                      <div>
                        <span style="font-weight:600; color:var(--text-primary);">${l.userName}</span>
                        <span style="margin:0 0.5rem; color:var(--text-muted);">·</span>
                        <span style="color:${dotColor}; font-weight:600; font-size:0.85rem;">${l.action}</span>
                      </div>
                      <time style="font-size:0.78rem; color:var(--text-muted); white-space:nowrap;">${timeStr}</time>
                    </div>
                    <p style="margin:0.35rem 0 0; color:var(--text-secondary); font-size:0.875rem;">${l.details}</p>
                  </div>
                </div>
              `;
            }).join('')}
